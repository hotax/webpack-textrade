<template>
  ...
  <div>
    ...
    <div class="row mt-3">
      <div class="col ml-2">
        <table class="table table-striped table-bordered animated fadeInLeft">
          <caption>采购交易数据导入表</caption>
          <thead>
            <tr>
              <th
          ...
          <tbody>
            ...
            >
              ...
              <td>{{task.data.task.appDate | relativeDate}}</td>
              ...
              <td>{{task.data.po}}</td>
              <td>{{task.data.review}}</td>
              <td>{{task.data.inInv}}</td>
              <td>{{task.data.outInv}}</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  data () {
    return {
      ...
      headers: [
        ...
        { name: '采购周期' },
        { name: '申请人', width: '80px' },
        { name: '申请日期', width: '110px' },
        { name: '审核人', width: '80px' },
        { name: '审核日期', width: '110px' },
        { name: '采购日期', width: '100px' },
        { name: '采购人', width: '80px' },
        { name: '到货日期', width: '110px' },
        { name: '领用人', width: '80px' },
        { name: '领用日期', width: '110px' },
        { name: '领用数量' },
